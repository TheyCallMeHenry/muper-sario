...
Greenfield extraction from v1 (`Laguna-S-2.1-MuperSario`). SMB-inspired HTML5 canvas platformer. **Procedural sprites/SFX** + optional **`.wav` BGM**. **No bundler** — ES6 modules over HTTP.
...
3. Read [`docs/EXTRACTION-MANIFEST.md`](docs/EXTRACTION-MANIFEST.md)
4. Read [`docs/V1-PITFALLS.md`](docs/V1-PITFALLS.md)
5. Read [`docs/QA-FINDINGS.md`](docs/QA-FINDINGS.md)
6. Read [`docs/RESEARCH-NOTES.md`](docs/RESEARCH-NOTES.md)
7. Call MCP `memory_session_start` with project `Muper_Sario_2.0`
8. Do not invent paths/commands — use this file
...
- Use port **38472** (v1)
- Deploy without user request (Pages auto-builds from `main`)
